...
infile <- "C:/Users/katie/OneDrive/Documents/Uni/PhD/CTT_Motus/UK_Bats_Node_Data"

#This is where you want your output to go
outpath <- "C:/Users/katie/OneDrive/Documents/Uni/PhD/CTT_Motus/UKBats_Analysis"
...
#EXAMPLE POSSIBLE VALUES (TRIAL TAG TIMES HAVE BEEN EDITED)
tags <- c("344C2D78")
start_time = as.POSIXct("2021-09-24 12:00:00", tz = "Europe/London")
end_time = as.POSIXct("2020-06-03 15:00:00", tz = "Europe/London")

all_data <- load_data(infile)#, starttime = start_time, endtime = end_time, tags = tags)  
...
indir <- "C:/Users/katie/OneDrive/Documents/Uni/PhD/CTT_Motus/UK_Bats_Data/UK Bats"
...
#tags <- read.csv("C:/Users/katie/OneDrive/Documents/Uni/PhD/CTT_Motus/UKBats_Data/Trial_Tag.csv", as.is=TRUE, na.strings=c("NA", ""), header=TRUE, skipNul = TRUE, colClasses=c("TagId"="character"))
